...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="card p-4 mb-4 contenedor-estatico">
    ...
    <div class="col-md-4">
        <div class="card bg-dark text-white p-4 mb-4 contenedor-estatico">
            <h5 class="fw-bold">¿Tenés dudas?</h5>
            <p>Contactanos y te respondemos en el momento.</p>
            <a href="/contacto-oga" class="btn btn-especial">Ir a Contacto</a>
        </div>
        <div class="card p-4 contenedor-estatico">
